...
(async()=>{ await new Promise(r=>server.listen(8899,r));
  ...
  const PAGES=[
    ...
    ["family-river-day.html","เที่ยวริมน้ำแบบครอบครัว — สวนลอยฟ้า เรือข้ามฟาก แล้วเข้าห้างเย็น ๆ ไม่ต้องเดินไกล","A Family River Day — a flat park, a short ฿5 boat, then a cool indoor afternoon, very little walking"],
