...
const I18N = {
  ...
  "about.body":      { th: "House of Happiness เป็นเซอร์วิสอพาร์ตเมนต์ 15 ยูนิต ทุกห้องเป็นแบบ 1 ห้องนอน มีห้องนั่งเล่นแยก ระเบียงวิวเมือง แอร์ ครัวเล็กพร้อมตู้เย็น และทีวีจอแบน มีเครื่องซักผ้าหยอดเหรียญส่วนกลาง ฟรี Wi-Fi และน้ำดื่มทุกการเข้าพัก",
                       en: "House of Happiness offers 15 serviced one-bedroom apartments, each with a separate living room, a city-view balcony, air conditioning, a kitchenette with refrigerator, and a flat-screen TV. A coin-operated laundry is available on site. Free Wi-Fi and complimentary bottled water with every stay." },
  "rooms.title":     { th: "ห้องพักและราคา", en: "Rooms & Rates" },
  "rooms.apt.name":  { th: "อพาร์ตเมนต์ 1 ห้องนอน", en: "One-Bedroom Apartment" },
  "rooms.apt.desc":  { th: "ห้องนอนแยก + ห้องนั่งเล่น · ระเบียงวิวเมือง · ครัวเล็ก ตู้เย็น · แอร์ · ทีวี · ห้องน้ำในตัว (ฝักบัว) · เลือกเตียงใหญ่หรือ 2 เตียงแยก (แจ้งตอนจอง) · พัก 2 ท่าน (สูงสุด 3)",
                       en: "Separate bedroom + living room · city-view balcony · kitchenette & fridge · air-con · TV · en-suite bathroom (shower) · double or twin beds (on request) · sleeps 2 (max 3)" },
  ...
  "gallery.twin":    { th: "ห้องเตียงคู่ (2 เตียงแยก)", en: "Twin room (2 single beds)" },
