...
const I18N = {
  ...
  "rooms.stu.desc":  { th: "2 เตียงแยก เหมาะเพื่อน/พี่น้อง · ระเบียงวิวเมือง · ตู้เย็น · แอร์ · ทีวี · ห้องน้ำในตัว · พัก 2 ท่าน",
                       en: "2 single beds, great for friends · city-view balcony · fridge · air-con · TV · en-suite bathroom · sleeps 2" },
  "rooms.dlx.name":  { th: "ห้อง Deluxe — ห้องใหญ่ พร้อมโซฟา", en: "Deluxe Room — Extra-Large with Sofa" },
  "rooms.dlx.desc":  { th: "ห้องใหญ่พิเศษ เตียงใหญ่ + มุมโซฟานั่งเล่นในห้องเดียวกัน · ระเบียงวิวเมือง · ตู้เย็น · แอร์ · ทีวี · ห้องน้ำในตัว · พัก 2 ท่าน (สูงสุด 3)",
                       en: "One extra-large room — double bed plus a sofa corner · city-view balcony · fridge · air-con · TV · en-suite bathroom · sleeps 2 (max 3)" },
  "rooms.from":      { th: "เริ่มต้น", en: "From" },
  "rooms.ask":       { th: "สอบถามราคา — ทัก LINE/WhatsApp", en: "Ask rates on LINE/WhatsApp" },
  "bk.roomnote":     { th: "ทุกห้องมีระเบียง ตู้เย็น ห้องน้ำในตัว", en: "Every room has a balcony, fridge and private bathroom" },
  "bk.askline":      { th: "💬 ราคา: สอบถามทาง LINE/WhatsApp ได้เลย — เราตอบไวมาก", en: "💬 Price: just ask us on LINE/WhatsApp — we reply fast" },
  ...
  "gallery.living":  { th: "มุมโซฟานั่งเล่น", en: "Sofa corner" },
  ...
  "faq.q2":          { th: "ต้องวางเงินมัดจำไหม?", en: "Is there a deposit?" },
  "faq.a2":          { th: "ไม่ต้องวางเงินมัดจำหรือค่าประกันความเสียหาย ชำระเฉพาะค่าห้อง (เงินสด โอน หรือพร้อมเพย์ — แจ้งรายละเอียดตอนยืนยันการจอง)",
                       en: "No key or damage deposit. You only pay for the room — cash, bank transfer or PromptPay; details come with your confirmation." },
  ...
  "cr.title":        { th: "เครดิตรูปภาพ", en: "Photo credits" },
  "cr.lead":         { th: "รูปสถานที่ท่องเที่ยวบนเว็บไซต์นี้มาจาก Wikimedia Commons ใช้ตามสัญญาอนุญาตครีเอทีฟคอมมอนส์ ซึ่งกำหนดให้ต้องระบุชื่อผู้ถ่ายและสัญญาอนุญาต · รูปห้องพักและอาคารทั้งหมดเป็นภาพถ่ายของเราเอง",
                       en: "The attraction photos on this site come from Wikimedia Commons and are used under Creative Commons licences, which require the photographer and licence to be named. All room and building photos are our own." },
  "cr.none":         { th: "ตอนนี้ไม่มีรูปที่ต้องระบุเครดิต", en: "No photos currently require attribution." },
  "cr.back":         { th: "← กลับไปหน้าที่เที่ยวใกล้ที่พัก", en: "← Back to things to do nearby" },
  ...
  "bk.sub":          { th: "สอบถามราคาและยืนยันไวทาง LINE/WhatsApp — เราตอบเร็วมาก", en: "Ask rates and get fast confirmation via LINE/WhatsApp — we reply quickly" },
  ...
  "bk.policy":       { th: "นี่คือ “คำขอจอง” — ทางโรงแรมจะตรวจสอบห้องว่างและยืนยันกลับภายใน 24 ชั่วโมง การจองสมบูรณ์เมื่อได้รับการยืนยันจากโรงแรม · เช็คอิน 14:00–22:00 น. (แจ้งเวลามาถึงล่วงหน้า) เช็คเอาท์ 12:00 น. · ไม่มีค่ามัดจำ · ชำระเงินสด โอน หรือพร้อมเพย์",
                       en: "This is a booking request — we check availability and confirm within 24 hours. Your booking is complete once confirmed by the hotel. Check-in 14:00–22:00 (please tell us your arrival time), check-out by 12:00. No deposit. Pay by cash, bank transfer or PromptPay." },
  ...
  "ph.yaowaratnight": { th: "ป้ายไฟร้านค้าเรียงแน่นสองฝั่งถนนเยาวราชตอนกลางคืน รถติดยาวกลางถนน", en: "Rows of lit shop signs down both sides of Yaowarat Road at night, traffic backed up in between" },
