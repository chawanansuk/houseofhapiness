...
const I18N = {
  ...
  "about.body":      { th: "House of Happiness เป็นเซอร์วิสอพาร์ตเมนต์ 15 ยูนิต มีห้องให้เลือก 3 แบบ — Standard เตียงใหญ่, Studio 2 เตียงแยก และ Deluxe ที่มีห้องนั่งเล่นแยกเป็นสัดส่วน ทุกห้องมีระเบียงวิวเมือง แอร์ ครัวเล็กพร้อมตู้เย็น และทีวีจอแบน มีเครื่องซักผ้าหยอดเหรียญส่วนกลาง ฟรี Wi-Fi และน้ำดื่มทุกการเข้าพัก",
                       en: "House of Happiness offers 15 serviced apartments in three styles — Standard (double bed), Studio (twin beds) and Deluxe (separate living room). Every unit has a city-view balcony, air conditioning, a kitchenette with refrigerator, and a flat-screen TV. A coin-operated laundry is available on site. Free Wi-Fi and complimentary bottled water with every stay." },
  "rooms.title":     { th: "ห้องพักและราคา", en: "Rooms & Rates" },
  "rooms.std.name":  { th: "ห้อง Standard — เตียงใหญ่", en: "Standard Apartment — Double Bed" },
  "rooms.std.desc":  { th: "เตียงใหญ่ 1 เตียง · ระเบียงวิวเมือง · ครัวเล็ก ตู้เย็น · แอร์ · ทีวี · ห้องน้ำในตัว (ฝักบัว) · พัก 2 ท่าน",
                       en: "1 double bed · city-view balcony · kitchenette & fridge · air-con · TV · en-suite bathroom (shower) · sleeps 2" },
  "rooms.stu.name":  { th: "ห้อง Studio — 2 เตียงแยก", en: "Studio Apartment — Twin Beds" },
  "rooms.stu.desc":  { th: "2 เตียงแยก เหมาะเพื่อน/พี่น้อง · ระเบียงวิวเมือง · ครัวเล็ก ตู้เย็น · แอร์ · ทีวี · ห้องน้ำในตัว · พัก 2 ท่าน (สูงสุด 3)",
                       en: "2 single beds, great for friends · city-view balcony · kitchenette & fridge · air-con · TV · en-suite bathroom · sleeps 2 (max 3)" },
  "rooms.dlx.name":  { th: "ห้อง Deluxe — มีห้องนั่งเล่นแยก", en: "Deluxe Apartment — Separate Living Room" },
  "rooms.dlx.desc":  { th: "ห้องนอนแยก + ห้องนั่งเล่นแยกเป็นสัดส่วน · โซฟา · ระเบียงวิวเมือง · ครัวเล็ก ตู้เย็น · แอร์ · ทีวี · ห้องน้ำในตัว · พัก 2 ท่าน (สูงสุด 3)",
                       en: "Separate bedroom + private living room with sofa · city-view balcony · kitchenette & fridge · air-con · TV · en-suite bathroom · sleeps 2 (max 3)" },
  ...
  "ab.f2":           { th: "ครัวเล็กในห้อง + ซักผ้าหยอดเหรียญ", en: "Kitchenette + coin laundry on site" },
