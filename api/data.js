...
function demoBookings(today) {
  ...
  return [
    ...
    mk("Mr. Liam O'Connor", 2, 5, "Booking.com", "ยืนยันแล้ว", 3, "", "2,400", "707twin"),
...
const REAL_ROOMS = ["701", "702", "703", "704", "705", "706", "707twin", "708twin",
  "709", "710", "713", "714-จองตรง", "715twin", "716", "717", "718",
  "งิ้ว2", "งิ้ว3"];

function demoRooms() {
  return REAL_ROOMS.map((no) => ({
    room: no, clean: (no === "702" || no === "708twin") ? "รอทำความสะอาด" : "สะอาด", note: "",
  }));
}
